        ...
        <div class="product-details">
            ...
            <div class="product-description">
                ...
                <div class="product-description-button">
                    ...
                    <a href="{{ route('add.to.cart', $product->id) }}" class="add-cart-btn" role="button">افزودن به سبد
                        خرید</a>
                    ...
                    <button type="button" class="favorit-btn" id="like-{{$product->id}}"
                        ...
                        <span class="material-icons @if($product->is_liked) like @endif"
                              title="افزودن به علاقه مندی ها">favorite_border </span>
                    </button>
                </div>
                    ...
                    @foreach($ww as $comment)
                        @if($comment->status != 0)
                            <li class="product-user-comment-item">
                                <div class="product-user-comment-star">نظر</div>
            ...
            <div class="user-comment-container">
                <form action="{{route('Client.comment.store', $product)}}" method="post">
                    ...
                    <div class="user-comment-text">
                        <textarea placeholder="متن دیدگاه خود را وارد نمایید" name="title" required></textarea>
                    </div>
