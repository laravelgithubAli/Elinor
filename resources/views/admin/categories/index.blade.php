...
@section('topfield')
    <div class="-intro-x breadcrumb ml-auto hidden sm:flex"><a href="">دسته بندی محصول</a> <i
            data-feather="chevron-left" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">لیست</a>
    </div>
@endsection
                                        ...
                                        <tr class="intro-x">
                                            <td class="w-40">
                                                <div class="flex">
                                                    ...
                                                    if($category->image!=null and $category->image!=""){
                                                        /*$image=url(str_replace('public','storage/app/public',$category->image)*/
                                                        $image=url(str_replace('public','/storage',$category->image));
                                                    }
                                                    ?>
                                            ...
                                            <td class="w-40">{{optional($category->parent)->title}}</td>
                                            <td class="table-report__action w-56">
                                                <div class="flex justify-center items-center">
                                                    <a class="flex items-center ml-3" href="{{route('categories.edit',$category)}}"> <i
