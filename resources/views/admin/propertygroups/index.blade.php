...
@section('content')
    ...
    <div class="content">
        ...
        <div class="top-bar">
            <!-- BEGIN: Breadcrumb -->
            <div class="-intro-x breadcrumb ml-auto hidden sm:flex"> <a href="">گروه ویژگی</a> <i data-feather="chevron-left" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">لیست</a> </div>
            <!-- END: Breadcrumb -->
            <!-- BEGIN: Search -->
                        ...
                        <div class="intro-y overflow-auto lg:overflow-visible mt-8 sm:mt-0">
                            <table class="table table-report sm:mt-2">
                                ...
                                @foreach($propertygroups as $propertygroup)
                                    <tr class="intro-x">
                                        <td>
                                            <a href="" class="font-medium whitespace-nowrap">{{$propertygroup->title}}</a>
                                        </td>
                                        <td class="table-report__action w-56">
                                            <div class="flex justify-center items-center">
                                                <a class="flex items-center ml-3" href="{{route('propertygroups.edit',$propertygroup)}}"> <i
