...
@section('content')
    ...
    <div class="content">
        ...
        <div class="top-bar">
            <!-- BEGIN: Breadcrumb -->
            <div class="-intro-x breadcrumb ml-auto hidden sm:flex"> <a href="">گروه ویژگی ها</a> <i data-feather="chevron-left" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">ویرایش</a> </div>
            <!-- END: Breadcrumb -->
            <!-- BEGIN: Search -->
            ...
            <div class="grid grid-cols-12 gap-6 mt-2 p-5">
                <div class="intro-y col-span-12 lg:col-span-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" value="{{$propertygroup->title}}" class="form-control bg-white">
                    </div>
