...
{{--                                        <td class="w-40 text-center">
                                            ...
                                            <div class="flex">
                                                <div class="w-10 h-10 image-fit zoom-in">
                                                    <img alt="Rubick Tailwind HTML Admin Template"
                                                         ...
                                                         src="{{str_replace('public','/storage',$image)}}"
                                                         title="">
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="w-40 text-center">
                                            <a href="" class="font-medium whitespace-nowrap ">{{$quantity}}</a>
                                        </td>
                                        <td class="w-40 text-center">
                                            <a href="" class="font-medium whitespace-nowrap ">{{$cost}}</a>
                                        </td>--}}
