...
@section('content')
    ...
    <div class="content">
        ...
        <div class="top-bar">
            <!-- BEGIN: Breadcrumb -->
            <div class="-intro-x breadcrumb ml-auto hidden sm:flex"> <a href="">نقش ها</a> <i data-feather="chevron-left" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">ویرایش</a> </div>
            <!-- END: Breadcrumb -->
            <!-- BEGIN: Search -->
                    ...
                    <div id="vertical-form" class="p-5">
                        <div class="preview">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" class="form-control bg-white" value="{{$role->title}}">
                            </div>
