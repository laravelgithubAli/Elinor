...
@section('content')
    ...
    <div class="content">
        ...
        <div class="top-bar">
            <!-- BEGIN: Breadcrumb -->
            <div class="-intro-x breadcrumb ml-auto hidden sm:flex"> <a href="">محصولات</a> <i data-feather="chevron-left" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">لیست محصولات</a> </div>
            <!-- END: Breadcrumb -->
            <!-- BEGIN: Search -->
                                    ...
                                    <tr class="intro-x">
                                        ...
                                        <td class="w-40">
                                            <a href="{{route('products.properties.index',$product)}}"
                                               class="btn btn-sm btn-danger"> مشخصات </a>
                                        </td>
